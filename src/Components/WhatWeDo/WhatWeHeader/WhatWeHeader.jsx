            ...
            <header className="bg-light">
                <div className="container">
                    <div className="row d-flex justify-content-between align-items-center">
                        ...
                        <div className="col-8">
                            <nav>
                            <ul className="d-flex justify-content-center list-unstyled pt-2">
                                <li className="p-3">
                                    <a href="#" className="text-decoration-none text-dark mb-5">HOME</a>
                                    <div className="dropdown-menu justify-content-center text-dark p-3 mt-2 rounded">
                                ...
                                <li className="p-3">
                                    <a href="#" className="text-decoration-none text-dark">PAGES</a>
                                ...
                                <li className="p-3">
                                    <a href="#" className="text-decoration-none text-dark">PORTFOLIO</a>
                                </li>
                                <li className="p-3">
                                    <a href="#" className="text-decoration-none text-dark">BLOG</a>
                                </li>
                                <li className="p-3">
                                    <a href="#" className="text-decoration-none text-dark">ELEMENTS</a>
                                </li>
                            </ul>
                            </nav>
                        </div>
                        <div className="col-2 justify-content-end d-flex">
                            <a href="#" className="text-decoration-none text-light">
                                ...
                                <FaBars className="fs-2 p-1 text-dark"  />
